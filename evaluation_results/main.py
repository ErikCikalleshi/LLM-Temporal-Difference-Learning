...
csv_file_path = 'Part 2 - Tabellenblatt1.csv'
responses_df = pd.read_csv(csv_file_path)

# Read the Google Sheet containing the formatted text
sheet_file_path = 'Historical Model Evaluation Survey- Part 2 (Antworten) - Formularantworten 1.csv'
...
fieldnames = list(responses_df[0].keys()) + ['Formatted Text']
